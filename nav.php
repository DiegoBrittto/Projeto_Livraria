...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">CyberTech</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <li><a href="carrinho.php"><span class="glyphicon glyphicon-shopping-cart"></span> Carrinho</a></li>
        ...
        <?php if (empty($_SESSION['ID'])){ ?>
              <li><a href="formlogon.php"><span class="glyphicon glyphicon-log-in"></span> Entrar </a> </li>
        <?php } 
            else { 
              if($_SESSION['STATUS'] == 0) 
              {          
          $consulta_usuario = $cn->query("select nm_usuario from usuario where cd_usuario = '$_SESSION[ID]'"); 
          ...
          <?php  } else { ?>
            <li><a href="adm.php"><button class="btn btn-sm btn-block btn-info" > Administrador </button> </a></li>
